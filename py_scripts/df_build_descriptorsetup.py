...
folder = (r"C:\Python\Projects\crystal-phase-prediction"
          r"\crystal_data\hfo2_La_m")
...
pd.to_pickle(df, r"C:\Python\Projects\crystal-phase-prediction\pkl_files"
             r"\structure_df_hfo2_La_defects_m.pkl")
