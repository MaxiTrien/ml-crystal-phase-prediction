...
@author: Maxi
Compare the calculated clusters to the predicted values from handcaluculated
formulas Validate the cluster performance
"""
...
clean_df_hfo2.to_pickle('./data_labels/labels_hfo2.pkl')
clean_df_zro2.to_pickle('./data_labels/labels_zro2.pkl')
